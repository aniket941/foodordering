        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="images/abc.png" alt=""></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
                </div>
            </nav>
        </div>
...
<table>
  ...
  <footer class="page-footer">
      ...
      <!--<div class="container">
        <span>© Prepared by: Mayank Anand <a class="grey-text text-lighten-4" href="#" target="_blank"></a> "In association with S J C institute of technology"</span>
        <span class="right"> Powered by: SJC Forum. Bangalore , India <a class="grey-text text-lighten-4" href="#">©  Pvt-Ltd, All rights reserved</a></span>
			</div> -->
			<div id="footer">
				<b class="copyright">&copy; Prepared by: </b> Aniket Singh.
						<br>    "In association with S J C institute of technology" </br>
						<br> <b> Powered by: SJC Forum. Bangalore , India </b></br></div>
						<b class="copyright">&copy;  Pvt-Ltd, All rights reserved </b></div>
    </div>
  </footer>
    <!-- END FOOTER -->
